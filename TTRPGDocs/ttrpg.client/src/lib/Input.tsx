...
function TextAreaInput({ value, setter, disabled, ...props }: { value: string, setter: (newValue: string) => void, disabled: boolean }) {
    ...
    return (<textarea {...props} value={value} disabled={disabled}
...
export default function Input<T>({ type, value, setter, label, field, disabled, ...props }: { type?: string, value: T, setter: (newValue: T) => void, label?: string, field?: keyof T, disabled?: boolean }) {
